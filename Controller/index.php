...
<!-- 
##### IDEAS #####
1. For the popular rooms carosel, you can add a feature so that the pictures are fetched fromthe database
...
<body class="leading-normal tracking-normal text-indigo-400 m-6 bg-cover p-6 bg-fixed" style="background-image: url('../VIew/assets/header.png');">
  <div class="h-full">
    ...
    <div class="w-full container mx-auto">
      <div class="w-full flex items-center justify-between">
        <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
          Leo's _<span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">Lodge</span>
        </a>

        <div class="flex w-1/2 justify-end content-center">
          <a class="inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out" href="https://www.facebook.com/LeosLodgeTacloban">
    ...
    <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
      <a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; 2024</a>
      - Made by
      <i class="text-gray-500 no-underline hover:no-underline">Obscure Group(Group 7)</i>
    </div>
  </div>
</body>
